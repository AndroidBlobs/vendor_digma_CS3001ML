...
include $(CLEAR_VARS)
LOCAL_MODULE := MusicBspPlus
LOCAL_MODULE_OWNER := digma
LOCAL_SRC_FILES := proprietary/vendor/app/MusicBspPlus/MusicBspPlus.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := digma
LOCAL_SRC_FILES := proprietary/vendor/app/UtClientApiService/UtClientApiService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := digma
LOCAL_SRC_FILES := proprietary/vendor/app/UtTAManager/UtTAManager.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := digma
LOCAL_SRC_FILES := proprietary/vendor/framework/lib_ut_capi_adapter.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_OWNER := digma
LOCAL_SRC_FILES := proprietary/vendor/framework/lib_ut_ta_manager.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
